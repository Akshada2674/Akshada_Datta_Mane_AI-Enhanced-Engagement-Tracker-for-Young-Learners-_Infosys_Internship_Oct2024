...
try:
    ...
    if not df.empty:
        df.to_excel(r'C:\Users\Akshada Mane\OneDrive\Desktop\Infosys Internship\Face_Recognition_Codes\Excel_Output\attendance_with_screenshots_2.xlsx', index=False)
        print("Attendance and screenshots saved to 'attendance_with_screenshots_2.xlsx'.")
