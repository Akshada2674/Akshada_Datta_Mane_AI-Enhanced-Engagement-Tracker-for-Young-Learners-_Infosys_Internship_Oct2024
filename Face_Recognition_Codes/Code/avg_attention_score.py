...
try:
    ...
    if not df.empty:
        ...
        df.to_excel(r'C:\Users\Akshada Mane\OneDrive\Desktop\Infosys Internship\Face_Recognition_Codes\Excel_Output\attendance_with_attention_and_average.xlsx', index=False)
